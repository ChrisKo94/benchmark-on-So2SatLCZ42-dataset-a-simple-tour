...
if distributional:
    if alpha > 0:
        train_distributions = h5py.File('/data/lcz42_votes/data/train_label_distributions' + '_alpha_' + str(alpha) + '.h5', 'r')
        y_train = np.array(train_distributions['train_label_distributions'])
        val_distributions = h5py.File('/data/lcz42_votes/data/val_label_distributions' + '_alpha_' + str(alpha) + '.h5', 'r')
